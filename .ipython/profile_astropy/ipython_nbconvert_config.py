...
# Template of the  data format to use.  I.E. 'article' or 'report'
...
# SlidesExporter will inherit config from: TemplateExporter, Exporter
...
# c.ServePostProcessor.reveal_cdn = 'https://cdn.jsdelivr.net/reveal.js/2.4.0'
